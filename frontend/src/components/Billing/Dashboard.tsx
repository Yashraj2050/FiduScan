        ...
        <div className="glass-card p-6 relative overflow-hidden flex flex-col">
          <div className="absolute top-0 right-0 p-6">
            {subscription?.status === 'active' || subscription?.status === 'trialing' ? (
              ...
              <span className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-gray-500/10 text-gray-400 border border-gray-500/20 text-xs font-semibold">
                Free
              </span>
            )}
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="flex items-baseline gap-2">
              <h3 className="text-3xl font-bold text-white capitalize">{subscription?.plan || 'Free'}</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="glass-card p-6">
            ...
            <div className="text-center p-6 bg-white/5 rounded-lg border border-white/10">
              ...
              <p className="text-sm text-white/50">No invoice history available.</p>
            </div>
          </div>
        </div>
      </div>
